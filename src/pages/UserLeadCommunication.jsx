...
const SOCKET_URL =
  ...
  (import.meta.env.VITE_API_URL
    ...
    : "https://launcherdesk-crm-backend.onrender.com");
...
function Avatar({ name, size = "md" }) {
  ...
  const colors = ["#059669", "#7E14FF", "#7E14FF", "#D97706", "#DC2626"];
    ...
    <div className={`flex mb-2 ${isOwn ? "justify-end" : "justify-start"} px-3`}>
      <div
        className={`max-w-[75%] px-3 py-2 rounded-2xl text-[13px] shadow-sm ${
          isOwn
            ? "bg-[#DCF8C6] dark:bg-[#005C4B] text-[#181029] dark:text-[#E3DAF3] rounded-br-none"
            : "bg-white dark:bg-[#1D1333] text-[#181029] dark:text-[#E3DAF3] rounded-bl-none border border-[#E7DCFA] dark:border-transparent"
        }`}
      >
        {isMedia ? (
          <div className="mb-1">
        ...
        <div className="flex items-center justify-end gap-1 mt-0.5">
          ...
          {isOwn && (
            <span className={`text-[10px] ${status === "read" ? "text-[#7E14FF]" : "text-[#9ca3af]"}`}>
...
function EmptyPane() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 px-6 bg-[radial-gradient(520px_320px_at_50%_40%,rgba(126,20,255,0.08),transparent_70%)] bg-[#FAF7FF] dark:bg-[#120B22]">
      <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#863BFF] to-[#6300D6] shadow-[0_14px_30px_-10px_rgba(126,20,255,0.6)] flex items-center justify-center mb-1">
        <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
        </svg>
      </div>
      <h3 className="font-display text-[20px] font-semibold tracking-tight text-[#170B29] dark:text-white">Select a Lead to Chat</h3>
      <p className="text-[13px] text-[#7D7296] dark:text-[#C6BBDC] text-center max-w-xs leading-relaxed">
    ...
    <div className="flex flex-col gap-2">
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[12px] text-[#170B29] dark:text-[#F4EEFF] placeholder:text-[#7D7296] focus:outline-none focus:border-[#25D366] transition"
          autoFocus
        />
        <select value={languageCode} onChange={(e) => setLanguageCode(e.target.value)}
          className="w-[110px] px-2 py-2 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[12px] text-[#170B29] dark:text-[#F4EEFF] focus:outline-none focus:border-[#25D366] transition">
...
function BlastTab({ leads, authHeaders }) {
  ...
  if (result) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center gap-6 bg-[#F7F3FF] dark:bg-[#0B0715] p-6">
        <div className="w-full max-w-md bg-white dark:bg-[#181029] rounded-2xl border border-[#E7DCFA] dark:border-[#2B1E48] p-8 text-center shadow-lg">
          ...
          <h2 className="text-[16px] font-bold text-[#170B29] dark:text-[#F4EEFF] mb-1">WhatsApp Blast Sent!</h2>
          <p className="text-[12px] text-[#7D7296] mb-5">Your template messages were dispatched to your leads.</p>
          <div className="grid grid-cols-3 gap-3 mb-5">
            {[
              { label: "Sent",   value: result.sent   ?? 0, color: "#25D366" },
              { label: "Failed", value: result.failed ?? 0, color: "#DC2626" },
              { label: "Total",  value: result.total  ?? 0, color: "#7E14FF" },
            ].map((s) => (
              <div key={s.label} className="bg-[#FAF7FF] dark:bg-[#120B22] rounded-xl p-3 text-center border border-[#E7DCFA] dark:border-[#2B1E48]">
                <div className="text-[22px] font-bold" style={{ color: s.color }}>{s.value}</div>
                <div className="text-[10px] text-[#7D7296] uppercase mt-0.5">{s.label}</div>
              </div>
            ))}
          </div>
          <button
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-start gap-0 bg-[#F7F3FF] dark:bg-[#0B0715] overflow-y-auto p-6">
      <div className="w-full max-w-lg">
        <div className="bg-white dark:bg-[#181029] rounded-2xl border border-[#E7DCFA] dark:border-[#2B1E48] p-6 mb-4 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-[15px] font-bold text-[#170B29] dark:text-[#F4EEFF] leading-none">WhatsApp Template Blast</h2>
              <p className="text-[11px] text-[#7D7296] mt-0.5">Send a template to all your assigned leads</p>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[13px] text-[#170B29] dark:text-[#F4EEFF] placeholder:text-[#7D7296] focus:outline-none focus:border-[#25D366]"
            />
            <p className="text-[10px] text-[#7D7296] mt-1">Must match exactly the approved template name in your MSG91 / Meta dashboard</p>
          </div>

          <div className="mb-5">
            <label className="block text-[12px] font-semibold text-[#4A3F66] dark:text-[#9A8DB6] mb-1.5">Template Language</label>
            <select
              value={languageCode}
              onChange={(e) => setLanguageCode(e.target.value)}
              className="w-full px-3 py-2.5 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[13px] text-[#170B29] dark:text-[#F4EEFF] focus:outline-none focus:border-[#25D366]"
            >
          ...
          <div className="bg-[#EFF6FF] dark:bg-[#1E3A5F]/30 border border-[#BFDBFE] dark:border-[#1D4ED8]/30 rounded-xl px-4 py-3 text-[11px] text-[#7E14FF] dark:text-[#93C5FD] mb-5">
        ...
        {leads.length > 0 && (
          <div className="bg-white dark:bg-[#181029] rounded-2xl border border-[#E7DCFA] dark:border-[#2B1E48] overflow-hidden shadow-sm">
            <div className="px-4 py-3 border-b border-[#E7DCFA] dark:border-[#2B1E48]">
              <p className="text-[12px] font-semibold text-[#4A3F66] dark:text-[#9A8DB6]">Leads that will receive the blast</p>
            </div>
            <div className="max-h-64 overflow-y-auto">
              {leads.map((lead) => (
                <div key={lead._id} className="flex items-center gap-3 px-4 py-2.5 border-b border-[#F4EEFF] dark:border-[#2B1E48] last:border-0">
                  <Avatar name={lead.name} size="sm" />
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-semibold text-[#170B29] dark:text-[#E3DAF3] truncate">{lead.name}</p>
                    <p className="text-[11px] text-[#7D7296] truncate">{maskPhone(lead.mobile || lead.phone)}</p>
                  </div>
...
function StartConversationPane({ lead, authHeaders, apiUrl, onStarted }) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-4 bg-[#F7F3FF] dark:bg-[#0B0715] p-6">
      ...
      <h3 className="text-[14px] font-bold text-[#4A3F66] dark:text-[#7D7296]">No WhatsApp conversation yet</h3>
      <p className="text-[11px] text-[#7D7296] text-center max-w-xs">
        Send the first template message to start a conversation with <strong>{lead.name}</strong>.
      </p>

      <div className="w-full max-w-sm bg-white dark:bg-[#181029] rounded-2xl border border-[#E7DCFA] dark:border-[#2B1E48] p-5 shadow-sm">
        <div className="mb-3">
          <label className="block text-[11px] font-semibold text-[#4A3F66] dark:text-[#9A8DB6] mb-1">
            Template Name <span className="text-red-500">*</span>
          </label>
          <input
            value={templateName}
            onChange={(e) => setTemplateName(e.target.value)}
            placeholder="e.g. crm_followup_leads"
            className="w-full px-3 py-2 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[13px] text-[#170B29] dark:text-[#F4EEFF] placeholder:text-[#7D7296] focus:outline-none focus:border-[#25D366] transition"
          />
          <p className="text-[10px] text-[#7D7296] mt-1">Must match exactly the approved template name in MSG91</p>
        </div>

        <div className="mb-4">
          <label className="block text-[11px] font-semibold text-[#4A3F66] dark:text-[#9A8DB6] mb-1">Language</label>
          <select
            value={langCode}
            onChange={(e) => setLangCode(e.target.value)}
            className="w-full px-3 py-2 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[13px] text-[#170B29] dark:text-[#F4EEFF] focus:outline-none focus:border-[#25D366] transition"
          >
            <option value="en">English (en)</option>
            <option value="en_US">English US (en_US)</option>
            <option value="hi">Hindi (hi)</option>
...
const LAUNCHERDESK_GREETINGS_TEMPLATE_ID_EMP = "6a1ffe028c6272147b00b233";
const LAUNCHERDESK_GREETINGS_SENDER_ID_EMP   = "695382";
const LAUNCHERDESK_GREETINGS_MESSAGE_EMP =
  "Hi {{name}}, thank you for contacting LAUNCHERDESK Digital Solutions LLP!" +
  ...
  "Phone: +91 88678 67775Website: LAUNCHERDESK Digital Solutions LLP";
...
function SmsBlastTab() {
  ...
  const [templateId, setTemplateId] = useState(LAUNCHERDESK_GREETINGS_TEMPLATE_ID_EMP);
  const [senderId,   setSenderId]   = useState(LAUNCHERDESK_GREETINGS_SENDER_ID_EMP);
  ...
  if (result) return (
    <div className="flex-1 flex flex-col items-center justify-center bg-[#F6F1FF] dark:bg-[#0B0715] gap-4">
      ...
      <h3 className="text-[18px] font-bold text-[#181029] dark:text-[#E3DAF3]">SMS Blast Queued!</h3>
      <p className="text-[13px] text-[#6E6386] dark:text-[#9A8DB6] text-center max-w-xs">{result.message}</p>
      {result.total && (
        <div className="flex items-center gap-2 bg-white dark:bg-[#1D1333] rounded-xl px-6 py-3 shadow-sm">
          <span className="text-[24px] font-bold text-[#EA580C]">{result.total}</span>
          <span className="text-[13px] text-[#6E6386] dark:text-[#9A8DB6]">messages queued</span>
        </div>
      )}
      <button
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#F6F1FF] dark:bg-[#0B0715] overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#5B00C7] via-[#7E14FF] to-[#9A4DFF] dark:from-[#2A1650] dark:via-[#2A1650] dark:to-[#2A1650] px-4 py-3 flex items-center gap-3 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {/* Mode selector */}
        <div className="bg-white dark:bg-[#1D1333] rounded-2xl p-4 shadow-sm">
          <p className="text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] uppercase tracking-wide mb-2">Send to</p>
              ...
              <button key={m.key} onClick={() => setMode(m.key)}
                className={`py-2 px-2 rounded-xl text-[11px] font-semibold border transition ${
                  mode === m.key
                    ...
                    : "border-[#E7DCFA] dark:border-[#2B1E48] text-[#7D7296] hover:border-[#EA580C] hover:text-[#EA580C]"
                }`}>
        ...
        <div className="bg-white dark:bg-[#1D1333] rounded-2xl p-4 shadow-sm space-y-3">
          {mode === "campaign" && (
            <div>
              <label className="block text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] mb-1.5">
              ...
              {leadCount !== null && (
                <p className="text-[11px] text-[#7D7296] mt-1">
          ...
          {mode === "single" && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] mb-1.5">Recipient Name</label>
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] mb-1.5">Mobile <span className="text-[#DC2626]">*</span></label>
          ...
          {mode === "csv" && (
            <div>
              <label className="block text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] mb-1.5">Paste CSV (name, mobile) <span className="text-[#DC2626]">*</span></label>
              ...
              <div className="flex items-center gap-2 mt-1.5">
                <button onClick={parseCsv} className="px-3 py-1.5 rounded-lg bg-[#F4EEFF] dark:bg-[#2B1E48] text-[11px] font-semibold text-[#4A3F66] border border-[#E7DCFA] dark:border-[#2B1E48] hover:border-[#EA580C] hover:text-[#EA580C] transition">Parse CSV</button>
          ...
          {/* MSG91 config fields */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-[#F4EEFF] dark:border-[#2B1E48]">
            <div>
              <label className="block text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] mb-1.5">DLT Template ID</label>
              ...
              <p className="text-[10px] text-[#7D7296] mt-0.5">MSG91 → DLT dashboard</p>
            </div>
            <div>
              <label className="block text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] mb-1.5">Sender ID</label>
              ...
              <p className="text-[10px] text-[#7D7296] mt-0.5">6-char DLT-approved</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1D1333] rounded-2xl p-4 shadow-sm">
          ...
          <div className="mb-3 p-3 bg-[#FFF7ED] dark:bg-[#1c0a00] border border-[#FED7AA] dark:border-[#7c3a00] rounded-xl flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={() => {
                setTemplateId(LAUNCHERDESK_GREETINGS_TEMPLATE_ID_EMP);
                setSenderId(LAUNCHERDESK_GREETINGS_SENDER_ID_EMP);
                setMessage(LAUNCHERDESK_GREETINGS_MESSAGE_EMP);
              }}
            ...
            >
              Use Launcherdesk_greetings
            </button>
          </div>

          <div className="flex items-center justify-between mb-2">
            <label className="text-[11px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] uppercase tracking-wide">
          ...
          <textarea
            ...
            placeholder={`Hi {{name}}, this is a message from Launcherdesk CRM.`}
          />
          <div className="flex items-center justify-between mt-1.5">
            <p className="text-[10px] text-[#7D7296]">
            ...
            <p className="text-[10px] text-[#7D7296]">→ <strong className="text-[#EA580C]">{recipientLabel}</strong></p>
          </div>
        </div>
        ...
        {message.trim() && (
          <div>
            <p className="text-[10px] font-semibold text-[#6E6386] dark:text-[#9A8DB6] uppercase tracking-wide text-center mb-2">Preview</p>
            <div className="flex justify-end px-2">
              <div className="max-w-[75%] bg-[#DCF8C6] dark:bg-[#005C4B] rounded-2xl rounded-tr-sm px-4 py-2.5 shadow-sm">
                <p className="text-[13px] text-[#181029] dark:text-[#E3DAF3] leading-relaxed whitespace-pre-wrap">{previewMsg}</p>
                <div className="flex items-center justify-end gap-1 mt-1">
                  <span className="text-[10px] text-[#6E6386] dark:text-[#9A8DB6]">now</span>
      ...
      {/* Send bar */}
      <div className="bg-[#F4EEFF] dark:bg-[#1D1333] px-4 py-3 flex items-center gap-3 shrink-0 border-t border-[#E7DCFA] dark:border-[#2B1E48]">
        <div className="flex-1 bg-white dark:bg-[#2B1E48] rounded-full px-4 py-2.5 text-[12px] text-[#6E6386] dark:text-[#9A8DB6] select-none">
          {message.trim()
            ? <span className="text-[#181029] dark:text-[#E3DAF3] truncate block">{message.slice(0, 60)}{message.length > 60 ? "…" : ""}</span>
...
function SmsChatBubble({ log }) {
  ...
  return (
    <div className="flex justify-end px-3 mb-2">
      <div className="max-w-[75%] px-3 py-2 rounded-2xl rounded-br-none text-[13px] shadow-sm bg-[#DCF8C6] dark:bg-[#005C4B] text-[#181029] dark:text-[#E3DAF3]">
        <p className="break-words leading-relaxed">{log.message}</p>
        <div className="flex items-center justify-end gap-1 mt-0.5">
          <p className="text-[10px] opacity-50">{ts}</p>
          <span className={`text-[10px] ${isOk ? "text-[#7E14FF]" : "text-red-400"}`}>
            {isOk ? "✓" : "✗"}
          </span>
        </div>
      </div>
...
function SmsChatTab({ leads, loadingLeads }) {
  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      ...
      <div className={`w-80 shrink-0 flex flex-col border-r border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029] ${selected ? "hidden sm:flex" : "flex"}`}>
        <div className="px-4 pt-5 pb-3 border-b border-[#E7DCFA] dark:border-[#2B1E48]">
          <h2 className="text-[15px] font-bold text-[#170B29] dark:text-[#E3DAF3] mb-3">SMS Direct</h2>
          <div className="relative">
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#7D7296]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-xl bg-[#F4EEFF] dark:bg-[#1D1333] text-[13px] text-[#170B29] dark:text-[#E3DAF3] placeholder:text-[#7D7296] focus:outline-none border border-transparent focus:border-[#EA580C]/40 transition"
            />
          </div>
        </div>
        <div className="flex-1 overflow-y-auto">
          {loadingLeads ? (
            <div className="flex items-center justify-center py-10 text-[#7D7296] text-[13px]">Loading…</div>
          ) : filteredLeads.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 gap-2 text-[#7D7296]">
            ...
            filteredLeads.map(lead => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 text-left border-b border-[#E7DCFA]/50 dark:border-[#2B1E48]/50 hover:bg-[#F4EEFF] dark:hover:bg-[#1D1333] transition ${isActive ? "bg-[#FFF3ED] dark:bg-[#EA580C]/10" : ""}`}
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-[12px] font-bold text-white shrink-0 ${isActive ? "bg-[#EA580C]" : "bg-[#6E6386]"}`}>
                    {(lead.name || "?").slice(0, 2).toUpperCase()}
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-semibold text-[#170B29] dark:text-[#E3DAF3] truncate">{lead.name || "Unknown"}</p>
                    <p className={`text-[11px] truncate ${hasMobile ? "text-[#7D7296]" : "text-amber-500"}`}>
      ...
      <div className="flex-1 flex flex-col bg-[#F4EEFF] dark:bg-[#0A1A20] min-w-0">
        {!selected ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-3 text-[#7D7296]">
            ...
            <p className="text-[14px] font-semibold text-[#4A3F66] dark:text-[#9A8DB6]">Select a lead to start SMS messaging</p>
          ...
          <>
            {/* Header */}
            <div className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-[#1F2C33] border-b border-[#E7DCFA] dark:border-[#2B1E48] shadow-sm">
              <button onClick={() => setSelected(null)} className="sm:hidden p-1 rounded-lg hover:bg-[#F4EEFF] dark:hover:bg-[#2B1E48] text-[#7D7296]">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[14px] font-bold text-[#170B29] dark:text-[#E3DAF3] truncate">{selected.name}</p>
                <p className="text-[11px] text-[#7D7296]">{maskPhone(selected.mobile) || "No mobile"} · SMS</p>
              </div>
              {configured === false && (
            ...
            <div className="flex-1 overflow-y-auto py-4">
              {loadingThread ? (
                <div className="flex items-center justify-center py-10 text-[#7D7296] text-[13px]">Loading messages…</div>
              ) : thread.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 gap-2 text-[#7D7296]">
            ...
            {/* Compose */}
            <div className="bg-white dark:bg-[#1F2C33] border-t border-[#E7DCFA] dark:border-[#2B1E48] px-4 py-3">
              {!selected.mobile ? (
                ...
                <>
                  ...
                  <div className="flex items-end gap-2">
                    <textarea
                      ...
                      className="flex-1 px-3 py-2.5 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#FAF7FF] dark:bg-[#120B22] text-[13px] text-[#170B29] dark:text-[#F4EEFF] placeholder:text-[#7D7296] focus:outline-none focus:border-[#EA580C]/60 transition resize-none"
                    />
                    <button
                      onClick={handleSend}
                  ...
                  <p className="text-[10px] text-[#7D7296] mt-1.5 px-1">
...
export default function UserLeadCommunication() {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  return (
    <div className="flex flex-col h-full overflow-hidden ld-canvas p-3 sm:p-5 gap-3 sm:gap-4">

      {/* ── Top tab bar ──────────────────────────────────────────────────── */}
      <div className="ld-hero rounded-3xl flex items-center gap-1.5 shrink-0 p-2 sm:p-2.5 overflow-x-auto">
        {[
          {
            key: "chat",
            label: "Chat",
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2.5 rounded-2xl text-[13px] font-semibold whitespace-nowrap transition ${
              activeTab === tab.key
                ? "bg-white text-[#6300D6] shadow-[0_6px_16px_-6px_rgba(20,0,60,0.5)]"
          ...
          >
            ...
            {tab.key === "sms" && (
              <span className="ml-1 bg-[#EA580C] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">
                SMS
              </span>
            )}
            {tab.key === "sms-direct" && (
      ...
      {/* ── Tab content ──────────────────────────────────────────────────── */}
      {activeTab === "sms" ? (
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden rounded-3xl ld-card border border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029]"><FeatureGate featureKey="sms-blast"><SmsBlastTab /></FeatureGate></div>
      ) : activeTab === "sms-direct" ? (
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden rounded-3xl ld-card border border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029]"><SmsChatTab leads={leads} loadingLeads={loadingLeads} /></div>
      ) : activeTab === "blast" ? (
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden rounded-3xl ld-card border border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029]">
        ...
        /* ── CHAT TAB ──────────────────────────────────────────────────── */
        <div className="flex flex-1 overflow-hidden rounded-3xl ld-card border border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029]">

          {/* Left panel: leads list — hidden on mobile when chat is open */}
          <div className={`w-80 shrink-0 flex flex-col border-r border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029] ${selected ? "hidden sm:flex" : "flex"}`}>
            <div className="px-4 pt-5 pb-3 border-b border-[#E7DCFA] dark:border-[#2B1E48]">
              <h2 className="font-display text-[18px] font-semibold tracking-tight text-[#170B29] dark:text-[#E3DAF3] mb-3 flex items-center gap-2">
                My Lead Chats
                {totalUnread > 0 && (
                  <span
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setSearch(e.target.value)}
                  placeholder="Search leads…"
                  className="w-full pl-9 pr-3 py-2 rounded-xl border border-[#E7DCFA] dark:border-[#2B1E48] bg-[#F4EEFF] dark:bg-[#1D1333] text-[13px] text-[#170B29] dark:text-[#E3DAF3] placeholder:text-[#7D7296] focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {loadingLeads || !activityLoaded ? (
                ...
                <div className="text-center py-12 text-[12px] text-[#7D7296]">
                ...
                filteredLeads.map((lead) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-3 text-left transition border-b border-[#F4EEFF] dark:border-[#2B1E48] ${
                        isActive ? "bg-[#F3EBFF] dark:bg-[#2B1E48] shadow-[inset_3px_0_0_#7E14FF]" : "hover:bg-[#FAF7FF] dark:hover:bg-[#1D1333]"
                      }`}
                    >
                      <Avatar name={lead.name} />
                      <div className="flex-1 min-w-0">
                        <p className={`text-[13px] truncate ${unread ? "font-bold text-[#170B29] dark:text-white" : "font-semibold text-[#170B29] dark:text-[#E3DAF3]"}`}>{lead.name}</p>
                        <p className="text-[11px] text-[#7D7296] truncate">{maskPhone(lead.mobile || lead.phone)}</p>
                        ...
                        {lastMessagePreview[lead._id] ? (
                          <p className={`text-[11px] truncate ${unread ? "text-[#170B29] dark:text-[#E3DAF3] font-medium" : "text-[#A6ABBD] dark:text-[#6E6386]"}`}>
                            {lastMessagePreview[lead._id]}
                          </p>
                        ) : null}
                      </div>
          ...
          {!selected ? (
            ...
            <div className="flex-1 flex items-center justify-center bg-[#F7F3FF] dark:bg-[#0B0715]">
            ...
            <div className={`flex flex-col overflow-hidden ${selected ? "flex-1" : "hidden sm:flex flex-1"}`}>
              ...
              {session && (
                <div className={`px-4 py-2 text-[11px] border-b border-[#E7DCFA] dark:border-[#2B1E48] ${
              ...
              {isClosed && (
                <div className="px-4 py-2 text-[11px] bg-[#FAF7FF] dark:bg-[#181029] text-[#7D7296] border-b border-[#E7DCFA] dark:border-[#2B1E48] text-center">
              ...
              >
                {loadingMsgs ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full gap-2 opacity-50">
                    <svg className="w-12 h-12 text-[#7D7296]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                    </svg>
                    <p className="text-[12px] text-[#7D7296]">No messages yet — start the conversation</p>
                  </div>
                ) : (
                  messages.map((msg, i) => (
                    <Bubble
              ...
              {(!sessionOpen || showTemplatePanel) && !isClosed ? (
                <div className="px-4 py-3 border-t border-[#E7DCFA] dark:border-[#2B1E48] bg-white dark:bg-[#181029] shrink-0">
                  <p className="text-[11px] text-[#7D7296] mb-2 text-center">
                    {sessionOpen
                  ...
                  {sessionOpen && (
                    <button
                      ...
                      className="mt-2 text-[11px] text-[#7D7296] hover:text-[#4A3F66] underline w-full text-center"
                    >
                ...
                <div className="bg-[#F4EEFF] dark:bg-[#1D1333] px-3 py-2.5 flex items-end gap-2 shrink-0 relative">
                  {/* ── Edit message modal (CRM copy only) ── */}
                  {editingMsg && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-[#2B1E48] shadow-2xl p-5">
                        <h3 className="text-[15px] font-bold text-[#181029] dark:text-[#E3DAF3] mb-1">Edit message</h3>
                        ...
                        <textarea
                          ...
                          rows={4}
                          autoFocus
                          className="w-full rounded-xl border border-[#E7DCFA] dark:border-[#3B295E] bg-white dark:bg-[#1D1333] px-3 py-2 text-[13px] text-[#181029] dark:text-[#E3DAF3] focus:outline-none focus:ring-2 focus:ring-[#25D366]/40 resize-none"
                        />
                        <div className="flex items-center justify-end gap-2 mt-3">
                          <button
                            type="button"
                            onClick={() => { setEditingMsg(null); setEditText(""); }}
                            className="px-3 py-2 text-[13px] font-semibold text-[#4A3F66] dark:text-[#C6BBDC] hover:underline"
                          >
                            Cancel
                          </button>
                          <button
                  ...
                  {/* ── Emoji picker ── */}
                  {showEmoji && !isClosed && (
                    <div className="absolute bottom-16 left-3 z-30 w-72 max-h-56 overflow-y-auto rounded-xl bg-white dark:bg-[#2B1E48] shadow-2xl border border-[#E7DCFA] dark:border-[#3B295E] p-2">
                  ...
                  {showAttachMenu && !isClosed && (
                    <div className="absolute bottom-16 left-3 z-30 w-56 rounded-xl bg-white dark:bg-[#2B1E48] shadow-2xl border border-[#E7DCFA] dark:border-[#3B295E] overflow-hidden">
                      {[
                        ...
                        <button
                          ...
                          className="w-full flex items-start gap-3 px-3 py-2.5 text-left hover:bg-[#F4EEFF] dark:hover:bg-[#1D1333] transition"
                        >
                          <Icon className="w-4 h-4 mt-0.5 text-[#25D366] shrink-0" />
                          <span className="min-w-0">
                            <span className="block text-[13px] font-semibold text-[#181029] dark:text-[#E3DAF3]">{label}</span>
                            <span className="block text-[10px] text-[#7D7296] truncate">{hint}</span>
                          </span>
                        </button>
                      ))}
                    </div>
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-white dark:bg-[#2B1E48] hover:bg-[#E3DAF3] dark:hover:bg-[#3B295E] disabled:opacity-40 flex items-center justify-center transition shrink-0 shadow-sm"
                  >
                    {uploading ? (
                      ...
                      <span className={`text-[22px] leading-none text-[#54656F] dark:text-[#C6BBDC] transition-transform ${showAttachMenu ? "rotate-45" : ""}`}>+</span>
                    )}
                  </button>
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-white dark:bg-[#2B1E48] hover:bg-[#E3DAF3] dark:hover:bg-[#3B295E] disabled:opacity-40 flex items-center justify-center transition shrink-0 shadow-sm text-[18px]"
                  >
                    🙂
                  </button>

                  <div className="flex-1 bg-white dark:bg-[#2B1E48] rounded-2xl px-4 py-2 min-h-[42px] flex items-center">
                    <textarea
                      ref={inputRef}
                      value={msgText}
                      onChange={(e) => setMsgText(e.target.value)}
                      ...
                      disabled={isClosed || sending}
                      className="w-full bg-transparent text-[13px] text-[#181029] dark:text-[#E3DAF3] placeholder:text-[#7D7296] resize-none focus:outline-none leading-relaxed disabled:opacity-50"
